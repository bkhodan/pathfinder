...
SRC		= 	mx_atoi.c mx_foreach.c mx_binary_search.c mx_strcmp.c mx_bubble_sort.c mx_swap_char.c \
			mx_printchar.c mx_strlen.c mx_print_unicode.c mx_printstr.c mx_quicksort.c \
			...
			mx_isspace.c mx_isalpha.c mx_isdigit.c mx_printerr.c mx_strchr.c \
			mx_islower.c mx_isupper.c mx_tolower.c mx_toupper.c mx_max.c mx_mid.c \
